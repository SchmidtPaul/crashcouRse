...
[UseR 3](DatR_multipledat.html) | Loops & Listen | `for(i in ...){...}`, `list()`
[UseR 4](appendix_desplot.html) | Ersellen von Feldplanabbildungen | `desplot()`
[UseR 5](DatR_MoreAdvanced.html) | Weitere Tipps | `dplyr`, `%in%`, `%>%`
