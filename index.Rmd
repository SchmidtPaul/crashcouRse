...
3. **Statistik**: Weiterführende, aber anschauliche Erläuterungen zur Statistik
...
[Stat 1](appendix_designs.html) | Vergleich Versuchsdesigns | -
[Stat 2](appendix_posthoc.html) | ANOVA & Post Hoc Tests | `anova()`, `emmeans()`
[Stat 3](appendix_interaktionen.html) | Behandlungsinteraktionen | -
[Stat 4](appendix_kovarstrukt.html) | Kovarianzstrukturen | `gls()` & `asreml()`
[Stat 5](intro_GLM_carrot.html) | Nicht-normalverteilte Daten | `glm()`
